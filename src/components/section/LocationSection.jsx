      ...
      <section className="flex flex-col items-center justify-center pt-8 max-w-md relative bg-white/20 rounded-2xl mx-auto">
        <div className="flex flex-col items-center text-center z-10 max-w-md mx-auto pb-10">
          ...
          <AnimatedSection variant="fadeInUp" delay={0.4}>
            <h3 className="text-1xl md:text-1xl font-light text-gray-300 mb-3 tracking-wider font-serif">09.00 WITA</h3>
            <h3 className="text-1xl md:text-1xl font-light text-gray-300 mb-3 tracking-wider font-serif">Jl. Kartini No,109 - Br. Wangaya Kaja</h3>
          </AnimatedSection>
        ...
        <div className="flex flex-col items-center text-center z-10 max-w-md mx-auto pb-10">
          ...
          <AnimatedSection variant="fadeInUp" delay={0.4}>
            <h3 className="text-1xl md:text-1xl font-light text-gray-300 mb-3 tracking-wider font-serif">15.00  WITA</h3>
            <h3 className="text-1xl md:text-1xl font-light text-gray-300 mb-3 tracking-wider font-serif">Jl. Kartini No,109 - Br. Wangaya Kaja</h3>
          </AnimatedSection>
          <AnimatedSection variant="fadeIn" delay={0.5}>
            <motion.button 
