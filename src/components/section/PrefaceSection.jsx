...
const PrefaceSection = () => {
  return (
    <section className="flex items-center justify-center  pb-12 relative">
      <div className="text-center z-10 max-w-md mx-auto pb-10">
        ...
        <AnimatedSection variant="fadeIn" delay={0.3} duration={0.8}>
          <div className="mb-2 text-sm text-gray-300 tracking-widest">
            <p>Atas Asung Kertha Wara Nugraha Ida Sang Hyang Widhi Wasa/Tuhan Yang Maha Esa, kami bermaksud mengundang Bapak/Ibu/Saudara/i untuk hadir pada Upacara Manusa Yadnya Pawiwahan (Pernikahan) kami.</p>
          </div>
        </AnimatedSection>
      </div>
    </section>
